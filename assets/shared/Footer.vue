<template>
  <footer class="grid grid-cols-4 gap-[1px] bg-black border-t-1 border-black">
    ...
    <div class="footer__links p-[40px]">
      <p class="text-gray-500 text-[18px] mb-[24px]">Товары</p>
      <ul>
        <li><a href="">Все товары</a></li>
        <li><a href="">Свежие цветы</a></li>
        <li><a href="">Высушенные цветы</a></li>
        <li><a href="">Живые цветы</a></li>
        <li><a href="">Дизайнерские вазы</a></li>
        <li><a href="">Ароматические свечи</a></li>
        <li><a href="">Освежители воздуха</a></li>
      </ul>
      <p class="text-gray-500 text-[18px] mb-[24px] mt-[24px]">Услуги</p>
      <ul>
        <li><a href="">Подписка на цветы</a></li>
        <li><a href="">Свадьбы & Мероприятия декор</a></li>
      </ul>
    </div>
    <div class="footer__about p-[40px]">
      ...
      <ul class="mt-[24px]">
        <li><a href="">Доставка & возвраты</a></li>
